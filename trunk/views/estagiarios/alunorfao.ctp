...
<?php foreach ($orfaos as $c_orfaos): ?>
    ...
    <td>
    <?php echo $html->link($c_orfaos['Aluno']['nome'], '/alunos/view/'. $c_orfaos['Aluno']['id']); ?>
    </td>
    ...
    <td>
    <?php echo $html->link('X', '/alunos/delete/'. $c_orfaos['Aluno']['id'], NULL, 'Tem certeza?'); ?>
    </td>
...
<p>Não há alunos sem estágio: <?php echo $html->link('retornar', '/estagiarios/index'); ?></p>
