...
<?php if (($this->Session->read('categoria') === 'administrador') || ($this->Session->read('categoria') === 'supervisor')): ?>
    ...
    <?php echo " | "; ?>
    <?php echo $html->link('Alunos sem inscrição','/Inscricaos/orfao/'); ?>
    <?php echo " | "; ?>
<?php endif; ?>
       
<?php echo $html->link("Solicitação de termo de compromisso", "/inscricaos/termosolicita", array('style'=>'color: red', 'font-weight: bold')); ?>

<div align="center">

<?php if ($this->Session->read('categoria') === 'administrador'): ?>
    <?php echo $form->create('Mural', array('action'=>'index')); ?>
    <?php echo $form->input('periodo', array('type'=>'select', 'label'=>array('text'=>'Mural de estágios da ESS/UFRJ', 'style'=>'display: inline'), 'options'=> $todos_periodos, 'default'=>$periodo)); ?>
    <?php echo $form->end(); ?>
<?php else: ?>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><?php echo $html->link($data['Mural']['id'], '/Murals/view/' . $data['Mural']['id']); ?></td>
