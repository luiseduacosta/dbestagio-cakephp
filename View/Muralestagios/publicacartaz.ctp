...
$pdf->SetX(56);
$pdf->MultiCell(140, 5, $mural[0]['Muralestagio']['instituicao'], 0, 'L');

$pdf->SetX(20);
$pdf->Cell(0, 0, 'Vagas: ');
$pdf->SetX(56);
$pdf->Cell(0, 0, $mural[0]['Muralestagio']['vagas']);
$pdf->Ln(5);

$pdf->SetX(20);
$pdf->Cell(0, 0, 'Beneficios: ');
$pdf->SetX(56);
$pdf->Cell(0, 0, $mural[0]['Muralestagio']['beneficios']);
$pdf->Ln(5);

$pdf->SetX(20);
$pdf->Cell(0, 0, 'Final de semana: ');
$pdf->SetX(56);
switch ($mural[0]['Muralestagio']['final_de_semana']) {
...
$pdf->SetX(56);
$pdf->Cell(0, 0, $mural[0]['Muralestagio']['cargaHoraria']);
$pdf->Ln(5);

$pdf->SetX(20);
$pdf->Cell(0, 0, 'Requisitos: ');
$pdf->SetX(56);
$pdf->MultiCell(140, 5, $mural[0]['Muralestagio']['requisitos'], 0, 'L');
$Y = $pdf->GetY();

$pdf->SetXY(20, $Y);
$pdf->Cell(0, 0, 'Área: ');
$pdf->SetX(56);
$pdf->Cell(0, 0, $mural[0]['Areaestagio']['area']);
$pdf->Ln(5);
...
$pdf->SetX(56);
switch ($mural[0]['Muralestagio']['horario']) {
...
$pdf->SetX(56);
$pdf->Cell(0, 0, date('d-m-Y', strtotime($mural[0]['Muralestagio']['dataInscricao'])));
$pdf->Ln(5);

$pdf->SetX(20);
$pdf->Cell(0, 0, 'Data seleção: ');
$pdf->SetX(56);
$pdf->Cell(0, 0, date('d-m-Y', strtotime($mural[0]['Muralestagio']['dataSelecao'])) . " Horário " . $mural[0]['Muralestagio']['horarioSelecao']);
$pdf->Ln(5);

$pdf->SetX(20);
$pdf->Cell(0, 0, 'Local da seleção: ');
$pdf->SetX(56);
$pdf->Cell(0, 0, $mural[0]['Muralestagio']['localSelecao']);
$pdf->Ln(5);

$pdf->SetX(20);
$pdf->Cell(0, 0, 'Forma de seleção: ');
$pdf->SetX(56);
switch ($mural[0]['Muralestagio']['formaSelecao']) {
...
$pdf->SetX(56);
$pdf->Cell(0, 0, $mural[0]['Muralestagio']['contato']);
$pdf->Ln(5);

$linhas = $pdf->GetNumLines($mural[0]['Muralestagio']['outras']);
if ($linhas > 20) {
	$pdf->setPrintHeader(false);
	$pdf->AddPage();
}
...
$pdf->SetX(20);
$pdf->MultiCell(180, 0, $mural[0]['Muralestagio']['outras'], 1, 'L');
