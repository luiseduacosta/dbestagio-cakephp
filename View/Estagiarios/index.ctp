...
$("#EstagiarioDocenteId").change(function() {
	var docente_id = $(this).val();
        ...
        if (url === "localhost") {        
            ...
            window.location="/estagiarios/index/index/docente_id:"+docente_id;
        }
})
...
<?php endif; ?>
    ...
    <tr>
        <?php if ($this->Session->read('categoria') != 'estudante'): ?>
        <td style='text-align:center'><?php echo $this->Html->link($aluno['Estagiario']['registro'], "/alunonovos/view/" . $aluno['Aluno']['registro']); ?></td>
            <?php endif; ?>    
