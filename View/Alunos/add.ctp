...
<fieldset>
    ...
    <table border="1">
        ...
        <tr>
            <td colspan="2">
                <?php echo $this->Form->input('nascimento', array('label'=>'Data de nascimento', 'value'=>$alunonovo['Alunonovo']['nascimento'], 'dateFormat'=>'DMY', 'minYear'=>'1910', 'empty'=>TRUE)); ?>
            </td>
        </tr>
        ...
        <tr>
            <td>
                <?php echo $this->Form->input('identidade', array('label'=>'Cartera de identidade', 'value'=>$alunonovo['Alunonovo']['identidade'])); ?>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <?php echo $this->Form->input('cep', array('value'=>$alunonovo['Alunonovo']['cep'])); ?>
            </td>
        </tr>
