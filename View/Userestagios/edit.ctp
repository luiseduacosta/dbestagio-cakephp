<div class="container">
    ...
    <?php echo $this->Form->input('categoria', array('label' => ['text' => 'Categoria: 2: Aluno, 3: Professor, 4: Supervisor', 'class' => 'col-lg-3 col-form-label'], 'options' => ['1' => 'Administrador', '2' => 'Estudante', '3' => 'Professor', '4' => 'Supervisor'])); ?>
    <?php echo $this->Form->input('password', array('type' => 'hidden')); ?>
    <?php echo $this->Form->input('numero', array('label' => ['text' => 'Digite o DRE, SIAPE, CRESS para estudante, professor ou supervisor respectivamente', 'class' => 'col-lg-3 col-form-label'])); ?>
