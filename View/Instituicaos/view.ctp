...
<table>
    ...
    <tr>
        <td>Visita institucional</td>
        <td>
            <?php
            if (!empty($instituicao['Visita'])) {
                foreach ($instituicao['Visita'] as $c_visita) {
                    echo $this->Html->link(date('d-m-Y', strtotime($c_visita['data'])), '/visitas/view/'.$c_visita['id']);
                }
            } else {
                echo "Sem dados";
            }
...
<?php if ($this->Session->read('categoria') === 'administrador'): ?>
    ...
    echo " | ";
    echo $this->Html->link('Visita', '/Visitas/add/instituicao:' . $instituicao['Instituicao']['id']);
    ?>
<?php else: ?>
    <?php
    echo $this->Html->link('Editar', '/Instituicaos/edit/' . $instituicao['Instituicao']['id']);
