...
$(document).ready(function(){
    ...
    $("#InstituicaoInstituicao").autocomplete("/mural/Instituicoes/listainstituicao", { maxItemsToShow:0 });
    $("#InstituicaoNatureza").autocomplete("/mural/Instituicoes/listanatureza");
    $("#InstituicaoBairro").autocomplete("/mural/Instituicoes/listabairro", { maxItemsToShow:0 });
...
echo $this->Form->input('expira', array('label'=>'Expira', 'empty'=>true));
