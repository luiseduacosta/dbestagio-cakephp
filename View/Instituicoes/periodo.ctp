...
<?php if ($this->Session->read('categoria') === 'administrador'): ?>
    ...
    <?php echo $this->Form->input('periodo', array('type' => 'select', 'label' => array('text' => 'Período ', 'style' => 'display: inline'), 'options' => $todososperiodos, 'default' => $periodo, 'empty' => ['0' => 'Selecione'])); ?>
